CREATE OR REPLACE PROCEDURE prc_listar_por_tonelada_por_hectare(
...
IS
    ...
    ROUND((SUM(rg.quantidade_RgtColh)/pp.area_Plant),2)
    ...
    GROUP BY rg.ID_Prcl_ck, pp.area_Plant
...
BEGIN
    ...
    GROUP BY ID_Cult_ck;
      ...
      OPEN cur;
        DBMS_OUTPUT.PUT_LINE('Lucros por toneladas por hectare:');
...
/*call prc_listar_por_tonelada_por_hectare(ID_Cult); */
