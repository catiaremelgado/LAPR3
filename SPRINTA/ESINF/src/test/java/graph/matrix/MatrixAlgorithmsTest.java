...
import static graph.Algorithms.diameterGraph;
...
class MatrixAlgorithmsTest {
    ...
    @Test
    public void test(){
        boolean[]visited=new boolean[completeMap.numVertices()];
        String[] pathKeys =new String[completeMap.numVertices()];
        Integer[] dist=new Integer[completeMap.numVertices()];
        LinkedList<String> path=new LinkedList<>();
        Algorithms.shortestPathDijkstra(completeMap,"Porto",Integer::compareTo,Integer::sum,0,visited,pathKeys,dist);
        Algorithms.getPath(completeMap,"Porto","Lisboa",pathKeys,path);
        ArrayList<String>listVertices=completeMap.vertices();
        for (int i = 0; i < dist.length; i++) {
            System.out.println("distancia porto a "+listVertices.get(i)+":"+dist[i]);
            System.out.println(pathKeys[i]);
        }
    ...
    public void testminDistGraph() {
        MatrixGraph<String,Integer> matrixGraph = minDistGraph(incompleteMap, Integer :: compare, Integer :: sum);
        MatrixGraph<String,Integer> expectedResult = new MatrixGraph<String,Integer>(false);

        expectedResult.addVertex("Porto");
        expectedResult.addVertex("Braga");
        expectedResult.addVertex("Vila Real");
        expectedResult.addVertex("Aveiro");
        expectedResult.addVertex("Coimbra");
        expectedResult.addVertex("Leiria");
        expectedResult.addVertex("Viseu");
        expectedResult.addVertex("Guarda");
        expectedResult.addVertex("Castelo Branco");
        expectedResult.addVertex("Lisboa");
        expectedResult.addVertex("Faro");
        expectedResult.addEdge("Porto", "Aveiro", 75);
        expectedResult.addEdge("Porto", "Braga", 60);
        expectedResult.addEdge("Porto", "Vila Real", 100);
        expectedResult.addEdge("Viseu", "Guarda", 75);
        expectedResult.addEdge("Guarda", "Castelo Branco", 100);
        expectedResult.addEdge("Aveiro", "Coimbra", 60);
        expectedResult.addEdge("Coimbra", "Lisboa", 200);
        expectedResult.addEdge("Coimbra", "Leiria", 80);
        expectedResult.addEdge("Aveiro", "Leiria", 120);
        expectedResult.addEdge("Leiria", "Lisboa", 150);
        expectedResult.addEdge("Porto", "Coimbra", 135);
        expectedResult.addEdge("Porto", "Lisboa", 335);
        expectedResult.addEdge("Porto", "Leiria", 195);
        expectedResult.addEdge("Vila Real", "Braga", 160);
        expectedResult.addEdge("Aveiro", "Braga", 135);
        expectedResult.addEdge("Coimbra", "Braga", 195);
        expectedResult.addEdge("Leiria", "Braga", 255);
        expectedResult.addEdge("Lisboa", "Braga", 395);
        expectedResult.addEdge("Aveiro", "Vila Real", 175);
        expectedResult.addEdge("Coimbra", "Vila Real", 235);
        expectedResult.addEdge("Leiria", "Vila Real", 295);
        expectedResult.addEdge("Lisboa", "Vila Real", 435);
        expectedResult.addEdge("Lisboa", "Aveiro", 260);
        expectedResult.addEdge("Viseu", "Castelo Branco", 175);
        System.out.println("Test MinDistGraph");
        System.out.println(matrixGraph);

        Assert.assertEquals(matrixGraph,expectedResult);
    ...
    public void testDiameter(){
        int result = diameterGraph(incompleteMap, Integer :: compare, Integer :: sum,0);
        int expected = 435;
